...
public class Main {
    ...
    private static double[] media = new double[MAX_ALUNOS];
    private static boolean nomesCadastrados = false;
    private static boolean notas1Cadastradas = false;
    private static boolean notas2Cadastradas = false;
    ...
    private static void cadastrarNomes(Scanner scanner) {
    ...
    private static void cadastrarNotas(Scanner scanner, int notaIndex) {
